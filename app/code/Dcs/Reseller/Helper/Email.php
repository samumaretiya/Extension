...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'reseller/email/email_template';
    ...
    */
    ...
    public function resellerEnquiryMailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
