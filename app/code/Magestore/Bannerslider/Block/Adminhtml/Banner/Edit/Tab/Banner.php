    ...
    protected function _prepareForm()
    {
        ...
        $elements['image'] = $fieldset->addField(
            ...
            [
                ...
                'name' => 'image',
                'note' => 'Allow image type: jpg, jpeg, gif, png. (Dimensions for: 1920px * 615px) ',
            ]
        );
		
		$elements['visibility'] = $fieldset->addField(
            'visibility',
            'select',
            [
                'label' => __('Visibility'),
        ...
        $style = 'color: #000;background-color: #fff; font-weight: bold; font-size: 13px;display:none';
