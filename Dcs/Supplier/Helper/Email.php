...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'supplier/email/email_template';
    ...
    */
    ...
    public function supplierEnquiryMailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
