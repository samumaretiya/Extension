...
{
    //const XML_PATH_EMAIL_RECIPIENT =  'contactsus/email/contactadminemail';

    const XML_PATH_ENABLED = 'contactsus/contactsus/enable_frontend';
    const XML_PATH_EMAIL_RECIPIENT = 'contactsus/email/recipient_email';
    const XML_PATH_GENERAL_NAME = 'trans_email/ident_general/name';
    const XML_PATH_GENERAL_EMAIL = 'trans_email/ident_general/email';
	const XML_PATH_SECRET = 'contactsus/contactsus/recapcha_secretkey';
