...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'contactsus/email/email_template';
    ...
    */
    ...
    public function contacEnquiryMailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
