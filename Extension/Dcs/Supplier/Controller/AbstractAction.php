...
namespace Dcs\Supplier\Controller;
...
abstract class AbstractAction extends \Magento\Framework\App\Action\Action
{
    ...
    const XML_PATH_ENABLED = 'supplier/general/enable_frontend';
    const XML_PATH_EMAIL_RECIPIENT = 'supplier/email/recipient_email';
    const XML_PATH_GENERAL_NAME = 'trans_email/ident_general/name';
    const XML_PATH_GENERAL_EMAIL = 'trans_email/ident_general/email';
	const XML_PATH_SECRET = 'supplier/general/recapcha_secretkey';
